...
@NgModule({
  ...
  declarations: [NumbersOnlyDirective, NavBarNewComponent, NavBarComponent, EnumToArrayPipe, UserNavBarComponent, AvailableSpotsComponent, FooterComponent, EmailUsComponent, SideBarComponent, RemovewhitespacesPipe],
  exports: [
    CommonModule,
    FormsModule,
    AgmCoreModule,
