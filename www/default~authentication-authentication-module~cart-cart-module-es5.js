...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~authentication-authentication-module~cart-cart-module"], {
  /***/
        ...
        value: function getAll() {
          ...
          if (document.cookie && document.cookie !== '') {
            document.cookie.split(';').forEach(function (currentCookie) {
              ...
              cookies[_this2.safeDecodeURIComponent(cookieName.replace(/^ /, ''))] = _this2.safeDecodeURIComponent(cookieValue);
            });
          }
    ...
    */
    (function (global, factory) {
      ...
      var close = function close(onClose, onAfterClose) {
        ...
        var removePopupAndResetState = function removePopupAndResetState() {
          if (!isToast()) {
            ...
            window.removeEventListener('keydown', globalState.keydownHandler, {
              capture: true
            });
      ...
      if (typeof window !== 'undefined' && typeof window.WeakMap !== 'function') {
        ...
        Symbol.iterator = Symbol('Symbol.iterator'); // http://webreflection.blogspot.fi/2015/04/a-weakmap-polyfill-in-20-lines-of-code.html
      ...
      function _main(userParams) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (!innerParams.toast) {
            ...
            window.addEventListener('keydown', globalState.keydownHandler, {
              capture: true
            });
  ...
  /***/
  function srcAppModelLoginLoginModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSharedAuthenticationLoginLoginServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var LoginService = /*#__PURE__*/function () {
      ...
      _createClass(LoginService, [{
        key: "userLogin",
        value: function userLogin(_userLogin) {
          return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.userLogin, _userLogin);
        }
      }, {
        key: "forgetPassword",
        value: function forgetPassword(_forgetPassword) {
          return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.forgetPassword, _forgetPassword);
        }
      }, {
        key: "resetPassword",
        value: function resetPassword(_resetPassword) {
          return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.resetPassword, _resetPassword);
        }
      }, {
        key: "changePassword",
        value: function changePassword(_changePassword) {
          return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.changePassword, _changePassword);
        }
      }]);
...
//# sourceMappingURL=default~authentication-authentication-module~cart-cart-module-es5.js.map