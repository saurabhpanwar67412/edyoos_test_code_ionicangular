...
class LoginService {
    ...
    userLogin(userLogin) {
        return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.userLogin, userLogin);
    }
    forgetPassword(forgetPassword) {
        return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.forgetPassword, forgetPassword);
    }
    resetPassword(resetPassword) {
        return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.resetPassword, resetPassword);
    }
    changePassword(changePassword) {
        return this.http.post(src_app_shared_routes_apiroutes__WEBPACK_IMPORTED_MODULE_1__["apiRoutes"].login.changePassword, changePassword);
    }
}
...
//# sourceMappingURL=default~authentication-authentication-module~cart-cart-module-es2015.js.map